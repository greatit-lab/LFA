...
class UploadDataFrame(QWidget):
    ...
    def initUI(self):
        ...
        # Add all components to the database layout
    ...
    def set_controls_enabled(self, enabled):
        """Enable or disable controls for upload data."""
